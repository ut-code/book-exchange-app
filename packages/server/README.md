...
Navigate to [http://localhost:4001/graphql](http://localhost:4001/graphql) in your browser to explore the API of your GraphQL server in a [GraphQL Playground](https://github.com/prisma/graphql-playground).
